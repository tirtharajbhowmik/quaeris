...
export const platformPage = {
  meta: {
    title: "Veris Platform — Governed Agentic Analytics",
    description:
      "See how Veris's three-pillar architecture — Smart Semantic Layer, Trusted AI Agents, and enterprise security — delivers governed analytics at enterprise scale.",
  },
  ...
  hero: {
    ...
    subcopy:
      "Veris is built on a governed semantic layer, trusted AI agents, and enterprise-grade security controls — so every answer your team gets is accurate, auditable, and role-scoped. Architecture is not a marketing claim. It is what prevents hallucinations.",
  ...
  architecture: {
    intro: {
      ...
      subcopy:
        "Most AI analytics tools apply governance as a permission layer on top of an existing BI stack. Veris encodes it at three levels simultaneously — in the semantic layer that defines your metrics, in the agents that answer questions, and in the security controls that scope every query. Each layer reinforces the others.",
    },
    pillars: [
      {
        icon: "bar-chart-2",
        title: "Governed Semantic Layer",
        body: "Your data team defines metrics once — revenue, activation rate, churn — inside Veris's Smart Semantic Layer. The layer auto-learns business definitions from user interaction; no upfront LookML or MDX modeling sprint is required. Every agent answer traces back to these certified definitions. Conflicting numbers across teams stop being a problem.",
        cta: {
          label: "Deep dive",
      ...
      },
      {
        ...
        body: "Role-based access controls are enforced at query time, not as a dashboard filter. Veris runs warehouse-native — your data never leaves your environment. Every query, every agent step, and every answer is logged in a full prompt-level audit trail. Bring your own model: connect OpenAI, Anthropic, Google, or Meta and switch as your compliance posture evolves.",
        cta: {
          label: "Deep dive",
    ...
    steps: [
      {
        ...
        body: "Veris connects directly to your existing Snowflake, BigQuery, Databricks, Azure Synapse, or Amazon Redshift instance. No data copying, no pipelines to rebuild. Your warehouse stays the system of record. SharePoint and Google Drive connect for document ingestion alongside structured warehouse data.",
  ...
  capabilities: {
    intro: {
      ...
      subcopy:
        "Veris is not a single feature wrapped in a product shell. Six integrated capabilities work together — and each one is governed by the semantic layer beneath it.",
    },
    items: [
      {
        icon: "languages",
      ...
      },
      {
        ...
        body: "Connect OpenAI, Anthropic, Google, or Meta models and switch as the landscape evolves. Veris is not the model gatekeeper. Your compliance team chooses the model; the governed layer stays constant.",
      },
      {
        icon: "file-search",
  ...
  engines: {
    intro: {
      ...
      subcopy:
        "Veris organizes its capabilities into three named engines. Each engine is a cluster of sub-capabilities with its own URL, so your team can navigate directly to the feature that serves their workflow.",
    },
    cards: [
      {
        icon: "search-code",
    ...
    cards: [
      {
        ...
        fixBody:
          "Veris is not the model gatekeeper. Connect OpenAI, Anthropic, Google, or Meta — and switch as your compliance posture or cost math evolves. The governed layer underneath stays constant regardless of which model sits above it.",
      },
      {
        index: "02",
        ...
        fixBody:
          "Veris's Smart Semantic Layer learns business definitions and data relationships from user interaction. It reduces the upfront authoring sprint every other semantic-layer product demands. Your team defines the rules; the layer handles the learning.",
      },
      {
        index: "03",
        ...
        fixBody:
          "Veris's Document Agents extract structured fields from contracts, invoices, and reports, then join them with warehouse data in a single natural-language query. Structured and unstructured data are co-equal citizens in the same governed system.",
      },
    ],
  },
  ...
  proof: {
    intro: {
      ...
      subcopy:
        "Six case studies are live on the Veris site. Named customer attribution improves both trust and AI citation rates. Prioritize de-anonymization of at least two before this page ships.",
    },
    cards: [
      {
  ...
  subpages: {
    ...
    cards: [
      ...
      },
      {
        ...
        desc: "Why your data never leaves your environment, and how Veris connects without pipelines or data copies.",
  ...
  faq: {
    ...
    miniCard: {
      ...
      body: "Book a 30-minute platform walkthrough with a Veris solutions engineer. We will connect to your warehouse and show you a governed answer against your own data.",
    ...
    items: [
      {
        ...
        answer:
          "No. Veris agents query the governed semantic layer — they do not generate numbers from a language model's training data. Every answer is grounded in the certified metric definitions your data team controls. If a question cannot be answered from the semantic layer, the agent says so rather than guessing.",
        defaultOpen: true,
      },
      {
        id: "faq-a2",
        ...
        answer:
          "No. Veris is warehouse-native. It connects directly to your existing Snowflake, BigQuery, Databricks, Azure Synapse, or Amazon Redshift instance and queries it in place. No data is copied, cached, or stored on Veris infrastructure.",
      },
      {
        id: "faq-a3",
        question:
      ...
      {
        id: "faq-a7",
        question: "Can Veris query documents alongside warehouse data?",
        answer:
      ...
      {
        id: "faq-a8",
        question: "Does Veris replace our existing BI tool?",
        answer:
          "Veris complements your BI stack rather than replacing it. It sits above your warehouse and semantic layer, giving business users a governed natural-language interface for exploratory and investigative questions. Scheduled, structured reports and dashboards continue to serve their current purpose. Veris handles the questions that do not fit a pre-built dashboard.",
      },
    ],
  },
